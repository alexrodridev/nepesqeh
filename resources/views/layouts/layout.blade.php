    ...
    <main class="container-fluid">
        <header class="row justify-content-center">
            <nav class="navbar col-12 navbar-expand-sm navbar-light">
                <a class="navbar-brand" href="{{ route('barra') }}"><h1>NepesqEH</h1></a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('barra') }}">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('barra') }}#artigos">Artigos</a>
                        </li>
                    </ul>
                    <form class="form-inline my-2 my-lg-0">
                        <a class="btn btn-success" href="{{ route('barra') }}#inscrever">Inscrever</a>
                        &nbsp;
